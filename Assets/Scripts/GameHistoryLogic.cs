...
public class WaveSpawner : MonoBehaviour
{
    ...
    public List<Wave> waves;            // Liste des vagues (limité à 10)
    public Transform spawnPoint;        // Point de spawn des ennemis

    [Header("UI Elements")]
    public TMP_Text waveCountdownText;  // Texte pour le compte à rebours
    public TMP_Text waveNumberText;     // Texte pour le numéro de la vague
    ...
    void Update()
    {
        ...
        // Déclenche le countdown vers la prochaine vague
        if (countdown <= 0f)
        {
    ...
    IEnumerator SpawnWave()
    {
        ...
        {
            yield break; // Arrêter si toutes les vagues ont été terminées
        }
        ...
        // Spawn des ennemis selon leur type et quantité
        foreach (var enemyType in currentWave.enemies)
        {
        ...
        waveIndex++; // Passer à la vague suivante
    }
    ...
    void SpawnEnemy(Transform enemyPrefab)
    {
        ...
        // Chaque ennemi détruit doit appeler "EnemyDied()"
    }
